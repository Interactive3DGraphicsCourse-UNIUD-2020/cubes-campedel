...
function generateGrass(container, coordinates, wireframe = false) {
	...
	// creazione del materiale erba, un cubo verde chiaro
	let materialGrass = new THREE.MeshStandardMaterial({ color: 0x90BF60, wireframe: wireframe });

	// istanziazione della varibile che conterrà la mesh del singolo cubo
	let mesh;
	...
	let combinedMesh = new THREE.Mesh(combinedGeometry, materialGrass);
